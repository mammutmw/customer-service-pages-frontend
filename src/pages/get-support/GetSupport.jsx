...
import SelfServiceOption from "../../components/selfServiceOption/SelfServiceOption";
      ...
      {recommendedTopic && (
        <Fragment>
          ...
          {recommendedTopic.selfServiceOption ? (
            <SelfServiceOption
              key={recommendedTopic.selfServiceOption.id}
              ...
              selfServiceID={recommendedTopic.selfServiceOption.id}
            />
          ) : (
            ""
          )}
